(function($) {
    $.fn.cityMultiple = function() {
        ...
        html += '<div class="cyy-title">已选择地区 <a href="javascript:;" class="cyy-city-delete" id="cyy-allDelete" title="全部删除"><i class="icoF">&#xe618;</i></a></div>';
        ...
        function setSelectCity(citiesObj) {
            ...
            for (var cityName in citiesObj) {
                var selectedItem = "";
                if (citiesObj[cityName].length === getCityData()[cityName].length) {
                    selectedItem = '<li   class="cyy-flod cyy-flod-close"><a href="javascript:;" class="city-switch"><i class="icoF">&#xe610;</i></a><span class="city-s">' + cityName + '</span><a href="javascript:;" city-data="' + cityName + '" class="cyy-city-delete city-delete " title="删除"><i class="icoF">&#xe618;</i></a>';
                    selectedItem += '<ul class="cyy-select">';
                } else {
                    selectedItem = '<li   class="cyy-flod cyy-flod-open"><a href="javascript:;" class="city-switch"><i class="icoF">&#xe610;</i></a><span class="city-s">' + cityName + '</span><a href="javascript:;"  city-data="' + cityName + '" class="cyy-city-delete city-delete " title="删除"><i class="icoF">&#xe618;</i></a>';
                    selectedItem += '<ul class="cyy-select ">';
                }
                for (var i = 0; i < citiesObj[cityName].length; i++) {
                    selectedItem += '<li data-city-s="' + citiesObj[cityName][i] + '"><span>' + citiesObj[cityName][i] + '</span><a href="javascript:;"  city-data="' + cityName + "_" + citiesObj[cityName][i] + '" class="cyy-city-delete city-delete" title="删除"><i class="icoF">&#xe618;</i></a></li>';
                }
                selectedItem += '</ul></li>';
        ...
        function getSelectedCityArray() {
            var cities = [];
            for (var cityName in getSelectedCity()) {
        ...
        function getCityData() {
            ...
            cities['广西'] = ['百色市', '北海市', '防城港市', '贵港市', '桂林市', '河池市', '贺州市', '来宾市', '柳州市', '南宁市', '钦州市', '梧州市', '玉林市', '崇左市'];
